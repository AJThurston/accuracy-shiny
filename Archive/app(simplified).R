  ...
  tabPanel("App",
    fluidPage(
      ...
      column(width=2,
        ...
        numericInput("pcut", label = h5("Predicted Cut Score"), value = 0.00, step = .05),
      ...
      column(width = 2,
        ...
        br(),
        br(),
        h4(strong(textOutput("text_predcut"), align = "right")),
        h4(strong(textOutput("text_correl"), align = "right")),
        br(),
        h4(strong(textOutput("text_TP"), align = "right")),
        h4(strong(textOutput("text_FN"), align = "right")),
        h4(strong(textOutput("text_TN"), align = "right")),
        h4(strong(textOutput("text_FP"), align = "right")),
        hr(),
        h4(strong(textOutput("text_Accuracy"), align = "right")),
        ...
        hr(),
        h4(strong(textOutput("text_Sensitivity"), align = "right")),
        h4(strong(textOutput("text_Specificity"), align = "right")),
...
#Text output -----
  output$text_predcut <- renderText({paste0("Predictor Cutoff: ", round(input$pcut, digits = 2))})
  output$text_correl <- renderText({paste0("Correlation: ", round(input$r, digits = 2))})
